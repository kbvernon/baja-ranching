...
% Same document-level indentation for ordered and unordered lists
...
\setlength{\footnotesep}{10pt}  % vertical space between footnotes
...
\captionsetup[figure]{
  labelfont={color=DarkSlateGray, bf},
